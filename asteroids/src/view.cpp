...
static const colour_t missileColour = rgb(255, 195, 50); /* Missile Colour - Orange */
static const colour_t rockColour = rgb(96, 96, 96); /* Rock Colour - Gray */
...
void drawSideBar(int score, float elapsed_time, int lives)
{
    ...
    case 3:
        heartBitFlip();
        graphics->drawBitmap(467, 141, flippedHeart, heart_width, heart_height, RED);
        graphics->drawBitmap(457, 141, flippedHeart, heart_width, heart_height, RED);
        graphics->drawBitmap(447, 141, flippedHeart, heart_width, heart_height, RED);
        break;
    case 2:
        graphics->drawBitmap(457, 141, flippedHeart, heart_width, heart_height, RED);
        graphics->drawBitmap(447, 141, flippedHeart, heart_width, heart_height, RED);
    ...
    case 3:
        ...
        graphics->fillRect(453, 172, 20, 4, GREEN);
        graphics->fillRect(430, 172, 20, 4, YELLOW);
        graphics->fillRect(407, 172, 20, 4, RED);
        break;
    case 2:
        graphics->fillRect(405, 171, 70, 6, WHITE);
        graphics->fillRect(430, 172, 20, 4, YELLOW);
